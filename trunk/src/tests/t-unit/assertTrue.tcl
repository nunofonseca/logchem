## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##
##  File Name:  assertTrue.tcl
##  @short      Check if the argument passed in evaluates to boolean TRUE
...
##  @c            the evaluated expression is NOT TRUE (i.e., boolean FALSE).
##  @c            In the case for which the expression DOES evaluate to TRUE
...
proc t-unit::assertTrue { expression { errorString "" } } {
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
##  Proc Name:  assertTrue
##  @short      Check if the argument passed in evaluates to boolean TRUE
...
##  @example    set values [t-unit::assertTrue this "Error: Not TRUE"]
##
##  @comment      This module file provides functionality to evaluate a Tcl
##  @c            expression and decide if the result of that evaluation is
##  @c            boolean TRUE.  The first argument passed is the expression
##  @c            to be evaluated.  An optional second argument, if not an
##  @c            empty string, constitutes a string literal that is used if
##  @c            the evaluated expression is NOT TRUE (i.e., boolean TRUE).
##  @c            In the case for which the expression DOES evaluate to TRUE
##  @c            the procedure returns "OK".  Otherwise, the procedure will
##  @c            return a standard error string, unless the optional second
##  @c            argument contains a string; in the second case the argument
...
##  @n            argument to evaluate to boolean TRUE.  All other values are
...
## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   if { "" == $errorString } {
      set errorReturn "NOT_TRUE: Expected expression evaluating to boolean TRUE; got"
   } else {
  ...
  ## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ##   Evaluate expression, then check if result is "TRUE"
  ##
  ...
  ## ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   if { [catch {[eval $expression]} result] } {
      set index [string first "TRUE" $result]
      if { -1 != $index } {
